module MediaMagick
  module ApplicationHelper
    ...
    def attachment_container_for_video(model, relation)
      raw "<input type=\"text\" name=\"#{model}[#{relation}]\" id=\"#{model}_#{relation}\" class=\"attachmentVideoUploaderField\"><a class=\"attachmentVideoUploader\" href=\"javascript://\">upload</a>"
    end
